...
export function BookFilters({
  ...
  return (
    <div ref={dropdownRef} className="relative inline-block w-full sm:w-auto">
      ...
      {isOpen && (
        <div className="absolute inset-x-4 sm:inset-x-auto left-0 sm:left-0 sm:right-auto mt-2 w-auto sm:w-96 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg z-50 max-h-[500px] overflow-y-auto">
