      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div ref={titleInputRef} className="relative">
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 dark:text-white [&:-webkit-autofill]:!bg-white [&:-webkit-autofill]:dark:!bg-gray-700 [&:-webkit-autofill]:dark:!text-white [&:-webkit-autofill]:dark:[box-shadow:0_0_0_1000px_rgb(55_65_81)_inset]"
