...
function AppContent() {
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 transition-colors pb-[env(safe-area-inset-bottom)]">
      <header className="bg-white dark:bg-gray-800 shadow-md transition-colors pt-[env(safe-area-inset-top)]">
        <div className="max-w-7xl mx-auto px-[max(0.75rem,env(safe-area-inset-left))] sm:px-[max(1.5rem,env(safe-area-inset-left))] lg:px-[max(2rem,env(safe-area-inset-left))] py-1.5 sm:py-4 relative">
